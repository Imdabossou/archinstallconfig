...
yes | yay -S mkinitcpio-firmware konsave epson-inkjet-printer-escpr2 opencl-amd xpadneo-dkms protonup-qt-bin jamesdsp-pipewire-bin rustdesk-bin gemini-cli
